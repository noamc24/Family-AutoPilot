...
function App() {
  ...
  function removeEvent(item: FamilyEvent) {
    ...
    askConfirmation(`למחוק את האירוע "${item.title}"${linkedTasks ? ` ואת ${linkedTasks} המשימות שנוצרו בעקבותיו` : ''}?`, () => { setData(previous => removeEventAndDependents(previous, item.id)); setDialog(null); setToast('האירוע והמשימות התלויות בו נמחקו') })
  }
